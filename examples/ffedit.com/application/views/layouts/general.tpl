...
<body>
	<div id="wrapper">
		...
		<div id="content">
            <div id="menu-area" tal:content="structure import/stack/menu"></div>
	        <div id="membership-menu" tal:omit-tag="true" tal:content="structure import/stack/membership-menu"></div>
			
			<div class="x"></div>
			
			<div style="background-color:#000; height:5px;"></div>
			<div style="background-color:#777; height:1px;"></div>
