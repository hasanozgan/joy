...
(function($) {
    ...
    function MoveSelected(fromGroup, toGroup) {
        var texts = [];
        var values = [];
        var method = (fromGroup.view == "box1View") ? "add" : "remove";
        $("#"+fromGroup.view+" option:selected").each(
            function(i, selected) {
        ...
        document.getElementById(fromGroup.view).disabled = true;
        document.getElementById(toGroup.view).disabled = true;

        $.post(
            $__application.site_root+"/FFEdit_Subscription/update", 
            {
                'type': $("#list_type").val(),
                'id': $("#list_id").val(),
                'values[]': values, 
            ...
            function(data) {
                document.getElementById(fromGroup.view).disabled = false;
                document.getElementById(toGroup.view).disabled = false;
